...
export const ENG_DOMAINS: EngDomainMeta[] = [
  { id: 'firmware',         serverKey: 'firmware',  href: '/firmware',         lsKey: 'ambient-fw-checklist-v2',         freezeKey: 'ambient-fw-frozen-v1',         checklistTotal: 26, checklistDefault: 14 },
  ...
  { id: 'cloudengineering', serverKey: 'cloud',     href: '/cloudengineering', lsKey: 'ambient-cloud-checklist-v2',      freezeKey: 'ambient-cloud-frozen-v1',      checklistTotal: 24, checklistDefault: 20 },
