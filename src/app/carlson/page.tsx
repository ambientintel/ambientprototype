...
function FlowGlowBg() {
  ...
  useEffect(() => {
    ...
    const create = function create(e: HTMLCanvasElement, t: () => Cfg) {
      // @ts-expect-error — minified canvas engine
      let a,l=e.getContext("2d"),i=0,n=0,r=performance.now(),o=[[188,130,243],[245,185,234],[141,159,255],[255,103,120],[255,186,113],[198,134,255]],s=[{fx:.31,fy:.47,px:0,py:.5*Math.PI},{fx:.53,fy:.29,px:Math.PI,py:1.2*Math.PI},{fx:.41,fy:.67,px:.7*Math.PI,py:0},{fx:.23,fy:.53,px:1.5*Math.PI,py:.8*Math.PI},{fx:.59,fy:.37,px:.3*Math.PI,py:1.7*Math.PI},{fx:.43,fy:.61,px:1.1*Math.PI,py:.3*Math.PI}],h=["#BC82F3","#F5B9EA","#8D9FFF","#FF6778","#FFBA71","#C686FF"],d=[...h],m=[...h],c=1,p=.45,g=e=>{const t=parseInt(e.replace("#",""),16);return[t>>16&255,t>>8&255,255&t]},u=()=>{const t=e.getBoundingClientRect(),q=window.devicePixelRatio||1;e.width=(t.width||window.innerWidth)*q,e.height=(t.height||window.innerHeight)*q,l.setTransform(q,0,0,q,0,0)},b=(e,t,a,i,n)=>{n=Math.max(0,Math.min(n,a/2,i/2)),l.beginPath(),l.moveTo(e+n,t),l.lineTo(e+a-n,t),l.arcTo(e+a,t,e+a,t+n,n),l.lineTo(e+a,t+i-n),l.arcTo(e+a,t+i,e+a-n,t+i,n),l.lineTo(e+n,t+i),l.arcTo(e,t+i,e,t+i-n,n),l.lineTo(e,t+n),l.arcTo(e,t,e+n,t,n),l.closePath()},f=u=>{const y=Math.min((u-r)/1e3,.05);r=u;const M=t(),_q=window.devicePixelRatio||1,x=e.width/_q,w=e.height/_q,k=x/2,S=w/2,v=Math.min(x,w);i+=M.speed*y,n+=.4*y,c=Math.min(1,c+y/.55),(p-=y)<=0&&c>=1&&(p=.4+.15*Math.random(),d=[...m],c=0,m=[...h].sort(()=>Math.random()-.5));const C=d.map((e,t)=>((e,t,a)=>{const[l,i,n]=g(e),[r,o,s]=g(t);return`rgb(${Math.round(l+(r-l)*a)},${Math.round(i+(o-i)*a)},${Math.round(n+(s-n)*a)})`})(e,m[t],c));l.clearRect(0,0,x,w),l.fillStyle="#080808",l.fillRect(0,0,x,w);const R=M.padding,F=M.strokeWidth,A=M.intensity,I=x-2*R,P=w-2*R,$=M.cornerRadius,z=v*M.blobSize;l.save(),b(R,R,I,P,$),l.clip(),l.globalCompositeOperation="screen",s.forEach((e,t)=>{const[a,n,r]=o[t],s=k+.4*I*Math.sin(i*e.fx+e.px),h=S+.4*P*Math.cos(i*e.fy+e.py),d=l.createRadialGradient(s,h,0,s,h,z);d.addColorStop(0,`rgba(${a},${n},${r},${.82*A})`),d.addColorStop(.42,`rgba(${a},${n},${r},${.36*A})`),d.addColorStop(1,`rgba(${a},${n},${r},0)`),l.beginPath(),l.arc(s,h,z,0,2*Math.PI),l.fillStyle=d,l.fill()}),l.restore();const B=(e,t,a)=>{let i;l.save(),t>0&&(l.filter=`blur(${t}px)`),l.globalAlpha=a,i=l.createConicGradient(n-Math.PI/2,k,S),C.forEach((e,t)=>i.addColorStop(t/C.length,e)),i.addColorStop(1,C[0]),l.strokeStyle=i,l.lineWidth=e,l.lineCap="round",b(R,R,I,P,$),l.stroke(),l.restore()};B(4.5*F,26*A,.3*A),B(2.8*F,14*A,.5*A),B(1.6*F,5*A,.72*A),B(F,0,1),a=requestAnimationFrame(f)};u(),a=requestAnimationFrame(f);const y=new ResizeObserver(()=>u());return y.observe(e),()=>{cancelAnimationFrame(a),y.disconnect()}
    };
...
function BtnCanvas() {
  ...
  useEffect(() => {
    ...
    if (!canvas) return;
    // @ts-expect-error — minified canvas engine
    const create = function create(e,t){let a,l=e.getContext("2d"),i=0,n=0,r=performance.now(),o=[[255,255,255],[210,210,210],[170,170,170],[240,240,240],[185,185,185],[225,225,225]],s=[{fx:.31,fy:.47,px:0,py:.5*Math.PI},{fx:.53,fy:.29,px:Math.PI,py:1.2*Math.PI},{fx:.41,fy:.67,px:.7*Math.PI,py:0},{fx:.23,fy:.53,px:1.5*Math.PI,py:.8*Math.PI},{fx:.59,fy:.37,px:.3*Math.PI,py:1.7*Math.PI},{fx:.43,fy:.61,px:1.1*Math.PI,py:.3*Math.PI}],h=["#ffffff","#d0d0d0","#aaaaaa","#888888","#cccccc","#f0f0f0"],d=[...h],m=[...h],c=1,p=.45,g=e=>{const t=parseInt(e.replace("#",""),16);return[t>>16&255,t>>8&255,255&t]},u=()=>{const t=e.getBoundingClientRect(),q=window.devicePixelRatio||1;e.width=t.width*q||window.innerWidth*q,e.height=t.height*q||window.innerHeight*q,l.setTransform(q,0,0,q,0,0)},b=(e,t,a,i,n)=>{n=Math.max(0,Math.min(n,a/2,i/2)),l.beginPath(),l.moveTo(e+n,t),l.lineTo(e+a-n,t),l.arcTo(e+a,t,e+a,t+n,n),l.lineTo(e+a,t+i-n),l.arcTo(e+a,t+i,e+a-n,t+i,n),l.lineTo(e+n,t+i),l.arcTo(e,t+i,e,t+i-n,n),l.lineTo(e,t+n),l.arcTo(e,t,e+n,t,n),l.closePath()},f=u=>{const y=Math.min((u-r)/1e3,.05);r=u;const M=t(),_q=window.devicePixelRatio||1,x=e.width/_q,w=e.height/_q,k=x/2,S=w/2,v=Math.min(x,w);i+=M.speed*y,n+=.4*y,c=Math.min(1,c+y/.55),(p-=y)<=0&&c>=1&&(p=.4+.15*Math.random(),d=[...m],c=0,m=[...h].sort(()=>Math.random()-.5));const C=d.map((e,t)=>((e,t,a)=>{const[l,i,n]=g(e),[r,o,s]=g(t);return`rgb(${Math.round(l+(r-l)*a)},${Math.round(i+(o-i)*a)},${Math.round(n+(s-n)*a)})`})(e,m[t],c));l.clearRect(0,0,x,w),l.fillStyle="#000000",l.fillRect(0,0,x,w);const A=M.padding,R=M.strokeWidth,F=M.intensity,I=x-2*A,P=w-2*A,$=M.cornerRadius,z=v*M.blobSize;l.save(),b(A,A,I,P,$),l.clip(),l.globalCompositeOperation="screen",s.forEach((e,t)=>{const[a,n,r]=o[t],s=k+.4*I*Math.sin(i*e.fx+e.px),h=S+.4*P*Math.cos(i*e.fy+e.py),d=l.createRadialGradient(s,h,0,s,h,z);d.addColorStop(0,`rgba(${a},${n},${r},${.82*F})`),d.addColorStop(.42,`rgba(${a},${n},${r},${.36*F})`),d.addColorStop(1,`rgba(${a},${n},${r},0)`),l.beginPath(),l.arc(s,h,z,0,2*Math.PI),l.fillStyle=d,l.fill()}),l.restore();const T=(e,t,a)=>{let i;l.save(),t>0&&(l.filter=`blur(${t}px)`),l.globalAlpha=a,i=l.createConicGradient(n-Math.PI/2,k,S),C.forEach((e,t)=>i.addColorStop(t/C.length,e)),i.addColorStop(1,C[0]),l.strokeStyle=i,l.lineWidth=e,l.lineCap="round",b(A,A,I,P,$),l.stroke(),l.restore()};T(4.5*R,26*F,.3*F),T(2.8*R,14*F,.5*F),T(1.6*R,5*F,.72*F),T(R,0,1),a=requestAnimationFrame(f)};u(),a=requestAnimationFrame(f);const y=new ResizeObserver(()=>u());return y.observe(e),()=>{cancelAnimationFrame(a),y.disconnect()}};
    return create(canvas, () => ({ cornerRadius: 6, speed: 0.27, blobSize: 1.8, intensity: 0.79, strokeWidth: 2, padding: 0 }));
  }, []);
  return <canvas ref={canvasRef} style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: 0 }} />;
}

/* ── CTA section canvas (Curl Noise) ────────────────────────────────────────── */
function CtaCanvas() {
  const canvasRef = useRef<HTMLCanvasElement>(null);
  useEffect(() => {
    const canvas = canvasRef.current;
    if (!canvas) return;
    // @ts-expect-error — minified canvas engine
    const create = function create(e,t){let a,l,i=e.getContext("2d"),n,r=0,o=-1,s=e=>{const t=43758.5453*Math.sin(e);return t-Math.floor(t)},h=(e,t)=>{const a=Math.floor(e),l=Math.floor(t),i=e-a,n=t-l,r=i*i*(3-2*i),o=n*n*(3-2*n);return s(a+57*l)*(1-r)*(1-o)+s(a+1+57*l)*r*(1-o)+s(a+(l+1)*57)*(1-r)*o+s(a+1+(l+1)*57)*r*o},d=(e,t,a)=>{let l=0,i=.5,n=1;for(let r=0;r<a;r++)l+=h(e*n+3.7*r,t*n+1.3*r)*i,n*=2,i*=.5;return l},m=()=>{const t=e.getBoundingClientRect();e.width=t.width,e.height=t.height,i.clearRect(0,0,t.width,t.height),o=-1},c=()=>{r+=.003;const s=t(),h=Math.round(s.count);h!==o&&(t=>{a=new Float32Array(t),l=new Float32Array(t);for(let i=0;i<t;i++)a[i]=Math.random()*e.width,l[i]=Math.random()*e.height;o=t})(h);const m=e.width,p=e.height,g=3*s.speed,u=s.noiseScale,b=Math.round(s.octaves);i.fillStyle=`rgba(8,10,14,${(1-s.fadeAlpha).toFixed(3)})`,i.fillRect(0,0,m,p);for(let e=0;e<h;e++){const t=a[e]/m*u,n=l[e]/p*u,o=(d(t,n+r+.002,b)-d(t,n+r-.002,b))/.004*g,h=-(d(t+.002,n+r,b)-d(t-.002,n+r,b))/.004*g,c=a[e],f=l[e];if(a[e]+=o,l[e]+=h,a[e]<0||a[e]>m||l[e]<0||l[e]>p){a[e]=Math.random()*m,l[e]=Math.random()*p;continue}const y=Math.sqrt(o*o+h*h),M=(s.hue+60*y)%360;i.beginPath(),i.moveTo(c,f),i.lineTo(a[e],l[e]),i.strokeStyle=`hsla(${M},75%,65%,0.55)`,i.lineWidth=.7,i.stroke()}n=requestAnimationFrame(c)};m(),c();const p=new ResizeObserver(()=>m());return p.observe(e),()=>{cancelAnimationFrame(n),p.disconnect()}};
    return create(canvas, () => ({ count: 200, noiseScale: 2.2, speed: 1.4, fadeAlpha: 0.96, hue: 195, octaves: 3 }));
  }, []);
  return <canvas ref={canvasRef} style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: 0 }} />;
}
...
function CardFlowGlowBg() {
  ...
  useEffect(() => {
    ...
    if (!canvas) return;
    // @ts-expect-error — minified canvas engine
    const create = function create(e,t){let a,l=e.getContext("2d"),i=0,n=0,r=performance.now(),o=[[188,130,243],[245,185,234],[141,159,255],[255,103,120],[255,186,113],[198,134,255]],s=[{fx:.31,fy:.47,px:0,py:.5*Math.PI},{fx:.53,fy:.29,px:Math.PI,py:1.2*Math.PI},{fx:.41,fy:.67,px:.7*Math.PI,py:0},{fx:.23,fy:.53,px:1.5*Math.PI,py:.8*Math.PI},{fx:.59,fy:.37,px:.3*Math.PI,py:1.7*Math.PI},{fx:.43,fy:.61,px:1.1*Math.PI,py:.3*Math.PI}],h=["#BC82F3","#F5B9EA","#8D9FFF","#FF6778","#FFBA71","#C686FF"],d=[...h],m=[...h],c=1,p=.45,g=e=>{const t=parseInt(e.replace("#",""),16);return[t>>16&255,t>>8&255,255&t]},u=()=>{const t=e.getBoundingClientRect();e.width=t.width||window.innerWidth,e.height=t.height||window.innerHeight},b=(e,t,a,i,n)=>{n=Math.max(0,Math.min(n,a/2,i/2)),l.beginPath(),l.moveTo(e+n,t),l.lineTo(e+a-n,t),l.arcTo(e+a,t,e+a,t+n,n),l.lineTo(e+a,t+i-n),l.arcTo(e+a,t+i,e+a-n,t+i,n),l.lineTo(e+n,t+i),l.arcTo(e,t+i,e,t+i-n,n),l.lineTo(e,t+n),l.arcTo(e,t,e+n,t,n),l.closePath()},f=u=>{const y=Math.min((u-r)/1e3,.05);r=u;const M=t(),x=e.width,w=e.height,k=x/2,S=w/2,v=Math.min(x,w);i+=M.speed*y,n+=.4*y,c=Math.min(1,c+y/.55),(p-=y)<=0&&c>=1&&(p=.4+.15*Math.random(),d=[...m],c=0,m=[...h].sort(()=>Math.random()-.5));const C=d.map((e,t)=>((e,t,a)=>{const[l,i,n]=g(e),[r,o,s]=g(t);return`rgb(${Math.round(l+(r-l)*a)},${Math.round(i+(o-i)*a)},${Math.round(n+(s-n)*a)})`})(e,m[t],c));l.clearRect(0,0,x,w),l.fillStyle="#080810",l.fillRect(0,0,x,w);const A=M.padding,R=M.strokeWidth,F=M.intensity,I=x-2*A,P=w-2*A,$=M.cornerRadius,z=v*M.blobSize;l.save(),b(A,A,I,P,$),l.clip(),l.globalCompositeOperation="screen",s.forEach((e,t)=>{const[a,n,r]=o[t],s=k+.4*I*Math.sin(i*e.fx+e.px),h=S+.4*P*Math.cos(i*e.fy+e.py),d=l.createRadialGradient(s,h,0,s,h,z);d.addColorStop(0,`rgba(${a},${n},${r},${.82*F})`),d.addColorStop(.42,`rgba(${a},${n},${r},${.36*F})`),d.addColorStop(1,`rgba(${a},${n},${r},0)`),l.beginPath(),l.arc(s,h,z,0,2*Math.PI),l.fillStyle=d,l.fill()}),l.restore();const T=(e,t,a)=>{let i;l.save(),t>0&&(l.filter=`blur(${t}px)`),l.globalAlpha=a,i=l.createConicGradient(n-Math.PI/2,k,S),C.forEach((e,t)=>i.addColorStop(t/C.length,e)),i.addColorStop(1,C[0]),l.strokeStyle=i,l.lineWidth=e,l.lineCap="round",b(A,A,I,P,$),l.stroke(),l.restore()};T(4.5*R,26*F,.3*F),T(2.8*R,14*F,.5*F),T(1.6*R,5*F,.72*F),T(R,0,1),a=requestAnimationFrame(f)};u(),a=requestAnimationFrame(f);const y=new ResizeObserver(()=>u());return y.observe(e),()=>{cancelAnimationFrame(a),y.disconnect()}};
    ...
    <div style={{ background: C.bg, color: C.text, fontFamily: C.sans, minHeight: '100vh' }}>
      ...
      <section className="c-sec" style={{ background: C.surf1, padding: '128px 80px' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <div className="c-three" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', border: `1px solid ${C.lineStrg}`, marginBottom: 2 }}>
            {[
              ...
              <div key={row.label} style={{ padding: '36px 44px', borderLeft: i > 0 ? `1px solid ${C.lineStrg}` : 'none' }}>
                <span style={{ display: 'block', fontFamily: C.mono, fontSize: 12, letterSpacing: '0.18em', color: C.gold, textTransform: 'uppercase', marginBottom: 12 }}>{row.label}</span>
          ...
          <div className="c-two" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', border: `1px solid ${C.lineStrg}` }}>
            {[
          ...
          <div className="c-three" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0, border: `1px solid ${C.line}` }}>
            {[
              ...
              <div key={card.title} className="c-mn-card" style={{ padding: '36px 32px 32px', borderLeft: i > 0 ? `1px solid ${C.line}` : 'none' }}>
                ...
                <p style={{ fontSize: 17, lineHeight: 1.72, color: C.text2, margin: 0 }}>{card.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── CTA ─────────────────────────────────────────────────────────────────── */}
      <Rule />
      <section className="c-cta" style={{ position: 'relative', overflow: 'hidden', padding: '120px 80px' }}>
        <CtaCanvas />
