...
const SYSENG_MILESTONES: { phase: string; milestone: string; detail: string; status: MilestoneStatus; date: string }[] = [
  ...
  { phase:'Validation',    milestone:'Bench-level algorithm validation', detail:'Controlled fall simulations using instrumented mannequin. Algorithm tested across 6 room configurations and 3 sensor mounting heights. Metrics logged to S3 Parquet cold path.',                        status:'complete',    date:'Q4 2025' },
  { phase:'Validation',    milestone:'Pilot site selection',            detail:'Mount Olivet Careview (FAC-MOCAREV-001), Minneapolis MN, selected as pilot site. IRB reliance agreement and data use agreement executed.',                                                                status:'complete',    date:'Q3 2025' },
  { phase:'Regulatory',    milestone:'Pre-submission (Q-Sub) to FDA',   detail:'Preparing Pre-Sub package to align with FDA on 510(k) pathway, predicate device selection, and clinical evidence requirements prior to formal submission.',                                               status:'in-progress', date:'Q2 2026' },
  { phase:'Regulatory',    milestone:'510(k) substantial equivalence',  detail:'Formal 510(k) submission targeting predicate under 21 CFR 882. Requires bench performance data, software documentation per IEC 62304, and risk file per ISO 14971.',                                    status:'planned',     date:'Q4 2026' },
  { phase:'Clinical',      milestone:'Observational pilot study',       detail:'Non-interventional study monitoring passive-monitoring events in consented residents at Mount Olivet Careview (MOCAREV-0001 through MOCAREV-0030). Primary endpoint: sensitivity and specificity of automated detection vs. staff-reported events.',                  status:'in-progress', date:'Q2 2026' },
];
...
const IRB_MILESTONES: { step: string; detail: string; status: MilestoneStatus; date: string }[] = [
  ...
  { step:'IRB application preparation',  detail:'Application materials prepared for University of Minnesota IRB: protocol, consent forms, data security plan, conflict of interest disclosures, and investigator credentials. Targeting expedited review category.',        status:'complete',    date:'Q3 2025' },
  { step:'IRB submission',               detail:'Full application package submitted to UMN IRB under expedited review. Minimal risk determination and no direct patient intervention confirmed.',                                                                            status:'complete',    date:'Q3 2025' },
  { step:'IRB approval',                 detail:'IRB approval received for observational, minimal-risk protocol at Mount Olivet Careview. MOCAREV-NNNN coded subject identifiers mandated by IRB per study-mvp.md §1.5.',                                                  status:'complete',    date:'Q4 2025' },
  { step:'Facility IRB reliance',        detail:'Mount Olivet Careview ceded IRB oversight to UMN via reliance agreement. Data use agreement (DUA) executed. FAC-MOCAREV-001 formally onboarded.',                                                                        status:'complete',    date:'Q4 2025' },
  { step:'Study initiation',             detail:'Site activated at FAC-MOCAREV-001. Sensor installation and coordinator training complete. First participants enrolled (MOCAREV-0001 through MOCAREV-0030).',                                                               status:'in-progress', date:'Q1–Q2 2026' },
...
const OVERVIEW_STATS = [
  ...
  { value:'Q4 2025', label:'IRB approved' },
];
