...
const SPRINT_FOCUS: Record<string, string[]> = {
  firmware: [
    ...
    'ambientapp v2 on main (schema + parquet + S3 done); next highest-priority: implement MQTT publisher (QoS 1 fall alerts)',
  ],
  ee: [
