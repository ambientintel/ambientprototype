    ...
    <div className="biodesign-root" style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)', fontFamily: 'var(--sans)', overflowX: 'hidden' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(ellipse 70% 60% at 50% 45%, rgba(45,114,210,0.10) 0%, rgba(45,114,210,0.04) 40%, transparent 70%)',
        }} />
        {/* Scan animation */}
        <div className="bd-scan" style={{ position: 'absolute', inset: 0, zIndex: 0 }} />
        {/* Corner accent lines */}
        <div style={{ position: 'absolute', top: 72, left: 40, width: 80, height: 80, borderTop: '1px solid rgba(45,114,210,0.2)', borderLeft: '1px solid rgba(45,114,210,0.2)', zIndex: 0 }} />
        <div style={{ position: 'absolute', top: 72, right: 40, width: 80, height: 80, borderTop: '1px solid rgba(45,114,210,0.2)', borderRight: '1px solid rgba(45,114,210,0.2)', zIndex: 0 }} />
        <div style={{ position: 'absolute', bottom: 160, left: 40, width: 80, height: 80, borderBottom: '1px solid rgba(45,114,210,0.2)', borderLeft: '1px solid rgba(45,114,210,0.2)', zIndex: 0 }} />
        <div style={{ position: 'absolute', bottom: 160, right: 40, width: 80, height: 80, borderBottom: '1px solid rgba(45,114,210,0.2)', borderRight: '1px solid rgba(45,114,210,0.2)', zIndex: 0 }} />
      ...
      <section style={{
        ...
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: 400, height: 400, border: '1px solid rgba(45,114,210,0.1)', borderRadius: '50%', zIndex: 0 }} />
