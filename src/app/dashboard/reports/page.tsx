    ...
    <div className="app notion-theme" style={notion}>
      ...
      <main className="main">
        <header className="topbar">
          ...
          <div style={{ display:'flex', gap:8, alignItems:'center' }}><button style={{ fontFamily:'var(--mono)', fontSize:11, padding:'7px 16px', borderRadius:6, border:'none', background:'var(--accent)', color:'white', cursor:'pointer' }}>+ Generate Report</button><AuthButton /></div>
        </header>
