    ...
    try {
      await fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          ...
          html: `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:40px 24px;background:#0a0a0a;color:#e5e5e5;border-radius:12px;"><p style="font-size:14px;color:#888;margin-bottom:8px;">Ambient Intelligence</p><h1 style="font-size:48px;font-weight:700;letter-spacing:0.15em;color:#fff;margin:0 0 16px;">${code}</h1><p style="font-size:14px;color:#aaa;margin:0 0 24px;">Enter this code to confirm your account. Expires in 15 minutes.</p><p style="font-size:12px;color:#555;">If you didn't request this, ignore this email.</p></div>`,
        }),
      });
    } catch {
      // email failure is non-fatal; still proceed
    }
