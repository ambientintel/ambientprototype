...
const SOURCES = [
  { cx: 0.50, cy: 0.44, color: [16,  185, 129] as [number, number, number] },
  { cx: 0.20, cy: 0.70, color: [6,   182, 212] as [number, number, number] },
  { cx: 0.80, cy: 0.22, color: [139, 92,  246] as [number, number, number] },
];
